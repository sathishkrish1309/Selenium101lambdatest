...
public class DragAndDropSlidersClass {
	...
	public void setup(Method m, ITestContext ctx) throws MalformedURLException {
		...
		String authkey = System.getenv("LT_ACCESS_KEY") == null ? "Y3YNFehD1Kip2kw05wEuaFlL8R1UtmFaUSvnq0o5kj8gZmdxwj" : System.getenv("LT_ACCESS_KEY");
	...
	public void TestScenario2() throws InterruptedException {
		...
		Actions action = (Actions) move.dragAndDropBy(slider3, 0, 95);
		action.perform();
